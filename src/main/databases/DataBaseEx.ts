...
export default class DataBaseEx{
    ...
    public createTables() : BetterSqlite3.Database{
        return this.#db!.exec(`
            ...
            INSERT OR IGNORE states VALUES(1, '所有:積読');
            INSERT OR IGNORE states VALUES(2, '所有：読書中');
            INSERT OR IGNORE states VALUES(3, '所有：読了');
            INSERT OR IGNORE states VALUES(4, '売却/破棄済み');
            INSERT OR IGNORE states VALUES(5, '貸借：返却済み（読了）');
            INSERT OR IGNORE states VALUES(6, '貸借：返却済み（未了）');
            INSERT OR IGNORE states VALUES(7, '貸借：現在貸出中');
        `);
    }
